public class FurnitureShop {
    ...
    public FurnitureShop(int count) {
        ...
        for (int i = 0; i < count; ) {
            goods[i++] = new Chair("standard model", 1.7, 0.4, 0.4,
                    "cloth", "Wood", true, 1300);
            if(i >= count) break;
            goods[i++] = new Table("standard model", 4, 1.65, 3.1,
                    1.9, 2700, "Wood", 3);
            if (i >= count)break;
    ...
    public String getPrices(){
        StringBuilder res = new StringBuilder("The store sells the following items:\n\n");
