public class Chair extends Furniture {
    ...
    public Chair(String modelName, double height, double width, double depth, String backseatMaterial,
                 String mainMaterial, boolean isCircle, int price) {
    ...
    @Override
    public void jumpOn() {
        System.out.println("Ouch! The chair broke when you tried to jump on it!");
    }
    @Override
